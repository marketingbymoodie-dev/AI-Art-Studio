...
| `extensions/theme-extension/assets/appai-cart-images.js` | Replaces cart thumbs from `_mockup_url`; **blocks** `/products/` navigation on AppAI lines (image + title). Pierce shadow DOM. |
