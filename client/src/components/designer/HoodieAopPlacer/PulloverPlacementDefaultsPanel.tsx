  ...
  return (
    ...
    >
      ...
      <p className="text-[10px] leading-snug text-muted-foreground">
        {isZip
          ? "Front body moves both zip halves. Pocket Y / scale moves both pocket halves on the app mockup and on Printify (on top of the built-in up-shift). Negative Y lifts the pockets. Save writes hood / front-body / pocket as template defaults."
